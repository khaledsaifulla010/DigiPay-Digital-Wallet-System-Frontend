  ...
  return (
    <div className="mt-12 ">
      <div className="flex items-center justify-between">
        <h3 className="font-bold text-3xl mt-8">My Profile</h3>
        <div>
          <EditProfileButton />
        </div>
      </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              <Avatar className="h-12 w-12">
                <AvatarFallback className="text-base font-bold border-2 border-dashed border-purple-600">
                  {initial}
                </AvatarFallback>
              </Avatar>
              <div className="space-y-1">
                ...
                <CardDescription>Admin Profile Overview</CardDescription>
              </div>
              ...
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Badge
                        className="bg-green-600 text-white font-bold mt-2"
                        variant="secondary"
                      >
                        <Shield /> {user?.role || role}
                      </Badge>
                    </TableCell>
                  </TableRow>
